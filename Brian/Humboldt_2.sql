...
ATTIDX."Line_Item_Heading" linehead,
  ...
  a.FBFile "Blob"
    ...
    FROM (SELECT * FROM FB_QSI_QY WHERE FFFORMLABEL IN 'Work Instruction ' AND FFSTATUS='Approved - Released' AND FBROWID=0 AND FFORGANIZATION ='76500') QYTBL 
/*
SELECT * FROM FB_QSI_QY WHERE fbdocid='535b7f488b53b' and ffversion='1'
SELECT * FROM FB_QSI_KEYWORDS_INDEX_QY where fbdocid = '535b7eee188a8'
--dept area--
'535b7eee188a8/1' <----
'535b7f488b53b/1'
--qytbl--
'535b70de674b8'
'535b7e8e8679d' <--this is the main document
'535b7f70f73a5'
