...
--DROP VIEW CPRO_STG.DANA_QSI_AI_ALL;

CREATE OR REPLACE VIEW DANA_QSI_AI_ALL
AS 
SELECT			
	...
	--QYTBL.FFQSI_SPECIAL_ORIGINATION QSI_SPECIAL_ORGKEY, --8.5 Specific
	'' QSI_SPECIAL_ORGKEY, --8.5 Specific
	...
	--QYTBL.FFQSI_VASSALHOST_UNIQUE_ID QSI_VASSAL_HUID  --8.5 Specific
	'' QSI_VASSAL_HUID  --8.5 Specific
	
	FROM FB_QSI_AI_QY QYTBL	INNER JOIN FB_QSI_AI MTBL ON MTBL.FBDOCID = QYTBL.FBDOCID		
