--DROP VIEW CPRO_STG.QSI_CU_MAIN;
--CREATE OR REPLACE VIEW DANA_QSI_CU_MAIN
--AS 
SELECT
...
FROM FB_QSI_CU_QY QYTBL	LEFT JOIN FB_QSI_MASTER_DATA_INDEX_QY MDTBL	
ON QYTBL.FFQSI_UNIQUE_ID = MDTBL.FFQSI_SOURCE_UNIQUE_ID AND MDTBL.FFQSI_SEQUENCE_NUMBER = -1 
