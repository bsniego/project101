...
MAX(CASE Metric_ID WHEN '5' THEN ResponseValue ELSE '0' END)+MAX(CASE Metric_ID WHEN '6' THEN ResponseValue ELSE '0' END) AS Total_VOL,
MAX(CASE Metric_ID WHEN '3' THEN ResponseValue ELSE '0' END)+MAX(CASE Metric_ID WHEN '4' THEN ResponseValue ELSE '0' END) AS Incident_TOTAL,
MAX(CASE Metric_ID WHEN '1' THEN ResponseValue ELSE '0' END)+MAX(CASE Metric_ID WHEN '2' THEN ResponseValue ELSE '0' END) AS Total_Def_QTY, 
round(((MAX(CASE Metric_ID WHEN '2' THEN ResponseValue ELSE '0' END)+MAX(CASE Metric_ID WHEN '1' THEN ResponseValue ELSE '0' END)) /
(MAX(CASE Metric_ID WHEN '5' THEN ResponseValue ELSE '0.00000001' END)+MAX(CASE Metric_ID WHEN '6' THEN ResponseValue ELSE '0.00000001' END))) * 1000000,2) AS PPM,
round(((MAX(CASE Metric_ID WHEN '4' THEN ResponseValue ELSE '0' END)+MAX(CASE Metric_ID WHEN '3' THEN ResponseValue ELSE '0' END)) /
(MAX(CASE Metric_ID WHEN '5' THEN ResponseValue ELSE '0.00000001' END)+MAX(CASE Metric_ID WHEN '6' THEN ResponseValue ELSE '0.00000001' END))) * 1000000,2) AS IPM
